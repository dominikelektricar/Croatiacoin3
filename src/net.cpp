...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Croatiacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"croatiacointools.com", "139.59.150.179"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"croatiacointools.com", "testnet-seed.croatiacointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Croatiacoin is probably already running."), addrBind.ToString().c_str());
        else
